...
|-|-|-|-|-|-|-|
| $${101.}$$ | ***Symmetric Tree*** | $${\color{lightgreen} Easy}$$ | [Problem101](https://leetcode.com/problems/symmetric-tree/description/) | [Hints](https://leetcode.com/problems/symmetric-tree/solutions/4511968/symmetric-tree-simplified-java/) | ***DFS, Two Way Recursion, Boolean Tree*** | ***Amazon, Tiktok*** |
