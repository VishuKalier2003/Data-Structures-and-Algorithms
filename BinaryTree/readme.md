...
| $${783.}$$ | ***Minimum Difference Between BST Nodes*** | $${\color{lightgreen} Easy}$$ | [Problem783](https://leetcode.com/problems/minimum-distance-between-bst-nodes/description/) | [Hints](https://leetcode.com/problems/minimum-distance-between-bst-nodes/solutions/4510148/minimum-difference-between-bst-nodes-simplified-java/) | ***DFS*** | ***Microsoft, Wix*** | 
